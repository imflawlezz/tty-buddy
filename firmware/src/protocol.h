...
// flags: bit0 cursor, bit1 blink, bit2 activity, bit4 style, bit5 status, bit7 bye
...
static constexpr uint8_t FLAG_STYLE = 0x10;    // style payload; may arrive without FLAG_STATUS
