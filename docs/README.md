...
Detailed notes beyond the root [README](../README.md).
...
| [hardware/wiring.md](../hardware/wiring.md) | Pin table aligned with firmware |
| [daemon/buddy.config](../daemon/buddy.config) | Shipped panel config template |
| [daemon/packaging/daemon.toml.example](../daemon/packaging/daemon.toml.example) | Shipped host config template |
